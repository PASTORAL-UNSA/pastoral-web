...
Esta carpeta contiene el contexto operativo/documental del repo `pastoral-web`, alineado al Producto 1 (landing institucional en Astro) de Pastoral UNSA.

## Orden recomendado de uso

1. Completar `00-project-context.md` al inicio del proyecto.
2. Completar `01-prd-context.md` para la primera version (v1) o el siguiente milestone.
...
- Actualiza `00-project-context.md` si cambia alcance o stakeholders.
- Manten `01-prd-context.md` sincronizado con el objetivo del Producto 1.
...
- Orientada a ejecucion: foco en decisiones, seguimiento y handoff claro.
- Coherente con documentacion fuente en `02-DOCU`.
- Minima pero completa: solo archivos esenciales, sin duplicidad.
